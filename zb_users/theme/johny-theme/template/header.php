{* Template Name:公共头部 *}
<!DOCTYPE html>
<html lang="{$lang['lang_bcp47']}" class="ace ace-card-on ace-tab-nav-on ace-main-nav-on ace-sidebar-on" data-theme-color="#c0e3e7">
<head>
    <meta charset="utf-8">
    ...
    <!-- Icon Fonts -->
    <link href="{$host}zb_users/theme/{$theme}/common/johny/fonts/icomoon/style.css" rel="stylesheet">
    <!-- Styles -->
    <link href="{$host}zb_users/theme/{$theme}/common/johny/js/plugins/highlight/solarized-light.css" rel="stylesheet">
    <link href="{$host}zb_users/theme/{$theme}/common/johny/style.css" rel="stylesheet">
    <!-- Modernizer -->
    <script type="text/javascript" src="{$host}zb_users/theme/{$theme}/common/johny/js/vendor/modernizr-3.3.1.min.js"></script>
    {$header}
            ...
            <div class="ace-head-container ace-container">
                <div class="ace-head-row">
                    <div id="ace-head-col1" class="ace-head-col text-left">
                        <a id="ace-logo" class="ace-logo" href="{$host}">
                            <img src="{$host}zb_users/theme/{$theme}/common/johny/img/uploads/brand/logo.svg" alt="ace resume"><span>.Certy</span>
                        </a>
                    </div>
