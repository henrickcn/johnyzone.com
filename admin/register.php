...
<div class="typecho-login-wrap">
    <div class="typecho-login">
        ...
        <form action="<?php $options->registerAction(); ?>" method="post" name="register" role="form">
            <p>
                <label for="name" class="sr-only"><?php _e('手机号'); ?></label>
                <input type="text" id="name" name="name" placeholder="<?php _e('手机号'); ?>" value="<?php echo $rememberName; ?>" class="text-l w-100" autofocus />
            </p>
            <p>
